                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody v-if="is_searched == false">
                            ...
                            <tr v-else v-for="branch in designation_list" :key="branch.id">
...
<script>
    ...
    export default{
        ...
        methods:{
            getAllBranch(){
                axios.get(this.$apiURL + '/designation_index/'+localStorage.getItem('id'))
                .then((res) => {
                    this.designation_list = res.data.designation_list;
                    if(this.designation_list.length == 0){
                        this.no_record = true;
                        this.loading = false;
                    }else{
